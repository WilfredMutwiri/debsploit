...
const Blog = () => {
  const blogPosts = [
      ...
      excerpt: "Explore the latest penetration testing methodologies and tools that are shaping the cybersecurity landscape this year.",
      author: "Alex Johnson",
      date: "March 15, 2024",
    ...
    },
    {
      ...
      excerpt: "Learn how to implement security best practices in your React applications to protect against common vulnerabilities.",
      author: "Sarah Chen",
      date: "March 10, 2024",
    ...
    },
    {
      ...
      excerpt: "Discover how artificial intelligence is revolutionizing cybersecurity and what it means for security professionals.",
    ...
    },
    {
      ...
      excerpt: "Understanding the importance of comprehensive cybersecurity training for organizations and their employees.",
      author: "Lisa Park",
    ...
    },
    {
      ...
      excerpt: "Effective digital marketing strategies specifically tailored for technology and cybersecurity companies.",
      author: "David Kim",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-card">
            ...
            <span className="text-sm text-cyber-blue font-medium">Latest Insights</span>
          </div>
              ...
              >
                ...
                <div className="relative h-32 bg-gradient-to-br from-secondary to-muted">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`px-3 py-1 text-sm font-medium rounded-full bg-${getCategoryColor(post.category)}/20 text-${getCategoryColor(post.category)}`}>
                      Featured
                    </span>
                  </div>
                </div>
                ...
                <div className="p-8 space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                      <span className={`px-2 py-1 rounded-md bg-${getCategoryColor(post.category)}/20 text-${getCategoryColor(post.category)}`}>
                        {post.category}
                      </span>
                    ...
                    <div className="flex items-center justify-between pt-4">
                      ...
                      <Button variant="default" className="text-black hover:text-white">
                        Read More
            ...
            <div className="glass-card p-6 cyber-glow">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground text-sm">
                  Subscribe to our newsletter for the latest cybersecurity insights and industry news.
                </p>
